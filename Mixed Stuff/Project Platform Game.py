...
pygame.display.set_caption('Frank Game ;)')
    ...
    def update(self):
        ...
        if self.timer <= 0:
            ...
            if abs(self.rect.centerx - player.rect.centerx) < TILE_SIZE * 1 and\
                ...
                player.health -= 50
            elif abs(self.rect.centerx - player.rect.centerx) < TILE_SIZE * 2.5 and \
                abs(self.rect.centery - player.rect.centery) < TILE_SIZE * 2.5:
                player.health -= 30
            for enemy in enemy_group:
                if abs(self.rect.centerx - enemy.rect.centerx) < TILE_SIZE * 1 and \
                    ...
                    enemy.health -= 80
                elif abs(self.rect.centerx - enemy.rect.centerx) < TILE_SIZE * 2.5 and \
                        abs(self.rect.centery - enemy.rect.centery) < TILE_SIZE * 2.5:
                    enemy.health -= 50
...
while run:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYUP:  # on release
            if event.key == pygame.K_a or event.key == pygame.K_LEFT:
                moving_left = False
            if event.key == pygame.K_d or event.key == pygame.K_RIGHT:
                moving_right = False
